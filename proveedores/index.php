...
<html lang="es">
 <head>
	...
	<title> Proveedores | SumiPan Los LLanos </title>
	<!-- CSS -->
    ...
    <script type="text/javascript" src="../bootstrap/js/proveedor.js"></script>
 </head>
  <body>
	...
	<div align="right" style="margin-top: -45px;">
		<button disabled="disabled" name="agregar_proveedor" id="agregar_proveedor" type="submit" class="btn btn-default" role="button">
			Nuevo Proveedor
		</button>
	</div>
	<?php 
    ...
    ?>
    <div align="right" style="margin-top: -45px;">	
	  	<button  name="agregar_proveedor" id="agregar_proveedor" type="submit" class="btn btn-default" role="button">
	  		Nuevo Proveedor
	  	</button>
	</div>
   ...
   <div class="row"> 
 	<?php 
 		...
 		if(isset($_GET["ver"])){    	  
	 		include('ver_proveedores.php'); 	  
	    }
	    
	 	elseif(isset($_POST["agregar_proveedor"])){
	 		 include("insertar_proveedores.php");  
	    } 
	    
	    elseif(isset($_GET["editar"])){	    	 
	 	include('editar_proveedores.php');	
	 	  if (isset($_POST["guardar_cambios_proveedor"])!=""){
	 	    include("actualizar_proveedores.php");	 		   	 			   
	      }
          ...
          <div class="col-md-12" style="margin-top: -6px; margin-bottom: 13px;">
                ...
                <div class="input-group"> 
			        <input required  id="autocomplete" type="text" class="form-control" placeholder="Ingresa el nombre del proveedor a buscar">
