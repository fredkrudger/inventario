...
<<<<<<< HEAD
	 $update_pro = "UPDATE proveedor SET nombre_proveedor='$nombre',direccion='$direccion',nombre_contacto='$contacto',id_ciudad='$ciudad',id_ubicacion='$estado' WHERE codigo_proveedor='$codigo_proveedor'";	   
=======
