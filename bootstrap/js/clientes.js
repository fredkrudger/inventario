...
<<<<<<< HEAD
                            html+='' + json.data[datos].direccion+'       ';
                            ...
                            html+='<a style="margin-left:5px" title="Eliminar Cliente" class="btn btn-sm btn-danger" href="javascript:eliminar('+json.data[datos].codigo_cliente+')"> Eliminar</a>';
