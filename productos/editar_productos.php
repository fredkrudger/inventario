...
<<<<<<< HEAD
              <input type="text" class="form-control" value="<?php echo $producto['precio']; ?>" onkeypress="return isNumberKey(event)" id="precio" name="precio" placeholder="Precio">
=======
...
<<<<<<< HEAD
      <input  type="text" class="form-control" id="fecha_vencimiento" name="fecha_vencimiento" value="<?php echo $producto['fecha_vencimiento']; ?>"onkeypress="return isNumberKey(event)" maxlength="10" placeholder="DD/MM/YYYY"> 
=======
...
<div class="form-group col-md-6"><br> 
    <label>
      ...
      <input type="text" class="form-control" id="cantidad_minima" name="cantidad_minima" value="<?php echo $producto['cantidad_minima']; ?>" onkeypress="return isNumberKey(event)" maxlength="8" placeholder="Cantidad Minima del Producto"> 
</div>
<br>
