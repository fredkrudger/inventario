...
<<<<<<< HEAD
	$results = $linki->prepare("SELECT codigo_producto,cantidad,precio,presentacion,nombre_producto FROM producto 
    	ORDER BY producto.codigo_producto
	DESC LIMIT $page_position, $item_per_page");
	$results->execute(); 
	$results->bind_result($codigo_producto,$cantidad,$precio,$presentacion,$nombre_producto);
=======
