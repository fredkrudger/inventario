...
<<<<<<< HEAD
		    $sqli="INSERT INTO cliente(nombre_cliente, id_ciudad, direccion, direccion_entrega,id_ubicacion, id_telefono, id_rif_cedula) VALUES ('$nombre', '$ciudad', '$direccion', '$direccionEntrega', '$estado', '".$_SESSION["ID_TLF"]."', '".$_SESSION["ID_R_C"]."')";
...
=======
		    $sqli="INSERT INTO cliente(nombre_cliente, ciudad, direccion, direccion_entrega,id_ubicacion, id_telefono, id_rif_cedula) VALUES ('$nombre', '$ciudad', '$direccion', '$direccionEntrega', '$estado', '".$_SESSION["ID_TLF"]."', '".$_SESSION["ID_R_C"]."')";
		    $result = $linki->query($sqli);
		          
		    if($linki->errno) die($linki->error);	    
		      if($result==true){      
>>>>>>> 446942e80d104328d6913c44f1a36546bf726908
		        echo '<script>alert("El cliente ha sido guardado Con Exito.");</script>';		       
